...
#show: ieee.with(
  ...
  index-terms: ("single-shot segmentation", "Segment Anything Model (SAM)", "point prompts", "DINOv2", "FSS-1000", "behavioral cloning", "reinforcement learning (RL)", "PPO"),
  bibliography: none,
)
